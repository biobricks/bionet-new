...
export default class Grid extends Component {
        ...
        render() {
            ...
            const backgroundImage="linear-gradient("+gridColorMajorAxis+" 2px, transparent 2px),linear-gradient(90deg, "+gridColorMajorAxis+" 2px, transparent 2px),linear-gradient("+gridColorMinorAxis+" 1px, transparent 1px),linear-gradient(90deg, "+gridColorMinorAxis+" 1px, transparent 1px)"
